    ...
    <BorderBox>
      ...
      <div className={styles.first_section}>
        ...
        <div className={styles.right_side_first}>
          <h1 className="">Discover the Joy of the Journey</h1>
          <p>
      ...
      <div className={styles.third_section}>
        ...
        <div className={styles.map_wrapper}>
          <img src="https://img.freepik.com/free-vector/digital-world-map_1017-8011.jpg" />
        </div>
      </div>
      ...
      <div className={styles.third_section}>
        ...
        <div className={styles.offer_wrapper}>
          <div className={styles.product_card}>
            <div>
              <img src="https://www.andbeyond.com/wp-content/uploads/sites/5/GettyImages-1205111263-RS.jpg" />
            </div>
            <h2>Magical Mauritius</h2>
            <p>7N / 8D</p>
            <div>
              <div>
                <p>Starts from</p>
          ...
          <div className={styles.product_card}>
            <div>
              <img src="https://pbs.twimg.com/media/EcjJcJXU0AEN1Tq.jpg" />
            </div>
            <h2>Dazzling waaji</h2>
            <p>7N / 8D</p>
            <div>
              <div>
                <p>Starts from</p>
          ...
          <div
            ...
            <div>
              <img src="https://5.imimg.com/data5/SELLER/Default/2023/10/351718846/JZ/BG/FN/199238502/goa-tour-package-service.png" />
            </div>
            <h2>Gleaming Goa</h2>
            <p>7N / 8D</p>
            <div>
